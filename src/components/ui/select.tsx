...
function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      ...
      data-size={size}
      className={cn(
        "border-input bg-background text-foreground data-placeholder:text-muted-foreground flex w-full min-w-0 items-center justify-between gap-2 rounded-[var(--radius-input)] border px-4 py-2 text-sm whitespace-nowrap",
        transition,
        focusRing,
